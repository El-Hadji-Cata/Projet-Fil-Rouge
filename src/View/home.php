...
<div class="container">
        ...
        <div class="bloc-milieu">
            <div class="engagmnt">
                <div class="engage">
                    ...
                    <p>Dècouvrez notre expertise et nos solutions pour accompagner
            ...
            <div class="eclaireur solidarite">
                ...
                <!-- <img src="pictures/Solidarite.jpg" alt=""> --> <!-- pictures/Solidarite.jpg -->
                <div class="text">
                    <h3>Solidarité</h3>
            ...
            <div class="eclaireur engagem">
                ...
                <!-- <img src="pictures/engage.jpg" alt=""> --> <!-- pictures/engage.jpg -->
                <div class="text">
                    <h3>Engagement</h3>
            ...
            <div class="eclaireur benevolat">
                ...
                <!-- <img src="pictures/benevolat.PNG" alt=""> --> <!-- pictures/benevolat.PNG -->
                <div class="text">
                    <h3>Bénévolat</h3>
            ...
            <div class="eclaireur missio">
                <div class="missn"></div>
                <!-- <img src="pictures/missions.jpg" alt=""> --> <!-- pictures/missions.jpg -->
                <div class="text">
                    <h3>Missions</h3>
    ...
    <section>
        <div class="dmd-renseigmnt">
            ...
            <p>Notre équipe est passionnée et sera ravie de vous aider à trouver
                ...
                Un certain nombre de nos employés ont eux-memes fait du volontariat à l'étranger.
        ...
        <form class="formulaire">
            <div class="firstn">
                <label id="first" for="firstname">Prénoms</label>
                <input type="text" id="firstname">
            </div>

            <div class="lastn">
                <label id="last" for="lastname">Nom de famille</label>
                <input type="text" id="lastname">
            </div>

            <div class="mail">
                <label id="email" for="mail">Votre email</label>
                <input type="email" id="mail" required> <!-- required pour la validation du formulaire-->
            </div>

            <div class="numtel">
                <label id="tele" for="tel">Numero de téléphone</label>
                <div class="numerotel">
                    <label id="pays" for="country"></label>
                    <select id="country">
            ...
            <!-- textarea-->
            <div class="mess">
                <label id="messge" for="message">Votre message</label>
                <div class="messa">
            ...
            <div class="check">
                <div>
                    ...
                    <label id="box" for="scales">J'accepte de recevoir les communications par SMS </label>
                </div>

                <div>
                    <input type="checkbox" id="scales" name="scales" />
                    <label id="box" for="scales">J'accepte de recevoir les communications par mail </label>
                </div>
            </div>
    ...
    <section class="client">
        <div class="avis">
            <img src="src/public/picture/photo-avis client 3.png" alt="">
            <p>
                Un outil tres adapté aux activités associatives,
                intuitif et convivialpour trouver de nouvelles missions.<br>
        ...
        <div class="avis">
            <img src="src/public/picture/photo-avis client 1.png" alt="">
            <p>
                Je vous remercie grandement pour votre aide
                et votre fléxibilité.
                Vraiment mille mercis.<br>
                <br>Camille
            </p>
            <div class="notes">
                <div class="fas fa-star"></div>
        ...
        <div class="avis">
            <img src="src/public/picture/photo-avis client 2.png" alt="">
            <p>
                Un outil tres adapté aux activités associatives,
                intuitif et convivialpour trouver de nouvelles missions.<br>
                Je recommande fortement<br>
    ...
    <section>
        <div class="plan">
            <h2>S'y Rendre</h2>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5565.121134610025!2d4.803126876596372!3d45.77999621231237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f4eb6be480055b%3A0x745aec47fc9bb10e!2s18%20Rue%20de%20la%20Claire%2C%2069009%20Lyon!5e0!3m2!1sfr!2sfr!4v1754754295964!5m2!1sfr!2sfr"
